...
Результаты анализа доступны для просмотра из [ноутбук](http://nbviewer.jupyter.org/github/mureich81/sf_dst97/blob/main/SF_PROJECT_1/Project_1_HHru.ipynb?flush_cache=true)
